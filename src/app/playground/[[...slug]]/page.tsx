            ...
            <Dialog open={isDialogOpen} onOpenChange={onOpenDialog}>
              <DialogTrigger asChild>
                <Button
                  ...
                  className=" border-transparent focus:border-transparent focus:ring-0 ml-2 lg:w-fit lg:mt-0 lg:mb-0 w-[90%] mt-4 mb-4 bg-indigo-500 hover:bg-indigo-600 h-11"
                  variant="default"
                >
                  Get Started{" "}
                  <Image
